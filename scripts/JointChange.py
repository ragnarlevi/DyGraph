...
if __name__ == '__main__':
    ...
    for temporal_penalty in ['element-wise', 'global-reconstruction', 'ridge',"block-wise-reconstruction", "perturbed-node"]: #'global-reconstruction', 'ridge'
        ...
        for nr_obs_per_graph in [100]:
            ...
            if temporal_penalty == 'global-reconstruction' and nr_obs_per_graph in [10,50]:
                continue
            ...
            for i in range(len(alpha)):
                for j in range(len(kappa)):
                    ...
                    dg_opt1.fit(Xs, nr_workers=10, temporal_penalty=temporal_penalty, lik_type="gaussian", verbose=False)
